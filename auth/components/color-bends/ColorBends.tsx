...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    (renderer as THREE.WebGLRenderer & { outputColorSpace?: THREE.ColorSpace }).outputColorSpace = THREE.SRGBColorSpace;
  ...
  useEffect(() => {
    ...
    if (color && palette.length === 0) palette.push(color);
    const arr = palette.map(toVec3);
  ...
  }, [rotation, autoRotate, speed, scale, frequency, warpStrength, mouseInfluence, parallax, noise, colors, transparent, color]);
